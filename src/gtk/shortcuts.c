...
const ShortcutDef default_shortcuts[] = {
    ...
    {"workspace.next.alt",GDK_KEY_Down,          GDK_CONTROL_MASK | GDK_ALT_MASK,   "Next workspace"},
    {"workspace.prev.alt",GDK_KEY_Up,            GDK_CONTROL_MASK | GDK_ALT_MASK,   "Previous workspace"},
    ...
    {"pane.focus.left",   GDK_KEY_Left,          GDK_CONTROL_MASK | GDK_SHIFT_MASK, "Focus pane left"},
    {"pane.focus.right",  GDK_KEY_Right,         GDK_CONTROL_MASK | GDK_SHIFT_MASK, "Focus pane right"},
    {"pane.focus.up",     GDK_KEY_Up,            GDK_CONTROL_MASK | GDK_SHIFT_MASK, "Focus pane up"},
    {"pane.focus.down",   GDK_KEY_Down,          GDK_CONTROL_MASK | GDK_SHIFT_MASK, "Focus pane down"},
